...
const userSchema = new mongoose.Schema({
  ...
  password: { type: String, required: true }, role: { type: String, enum: ['admin','hr','manager','employee'], default: 'employee' },
  employeeId: { type: String }, avatar: String, status: { type: String, default: 'Active' }
}, { timestamps: true });
